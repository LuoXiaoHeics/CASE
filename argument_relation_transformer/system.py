...
class ArgumentRelationClassificationSystem(pl.LightningModule):
    def __init__(self, hparams, al_selected_data_path=None):
        ...
        self.model_path = hparams.huggingface_path
        ...
        self.tokenizer = RobertaTokenizer.from_pretrained(self.model_path , cache_dir='./cache')
        ...
        for ids, p, l, i_str in zip(batch["ids"], pred, labels, batch["input_str"]):
            ...
            if rel_dir == "backward":
                ...
                for tail_i in range(cur_samples):
                    ...
                    # print(doc_id[1],tail_real_idx,head_prop_id)
    ...
    def test_epoch_end(self, test_step_outputs):
        ...
        # log results to disk
        output_path = f"{self.output_dir}/{self.exp_name}.jsonl"
