...
def run_evaluation(output_path, label_path, task):
    ...
    macro_prec, macro_rec, macro_f1_1, _ = precision_recall_fscore_support(
        y_true, y_pred, average=None, zero_division=0,labels=['support', 'attack', 'no-rel']
    )
    print('各类的F1值: '+str(macro_f1_1))
    ...
    results = {
        ...
        'support_F1': macro_f1_1[0],
        'attack_F1': macro_f1_1[1],
        'no-rel_F1': macro_f1_1[2]
    }
...
def main():
    ...
    parser.add_argument("--dataset", type=str,  choices=DOMAINS,default = 'ukp')
